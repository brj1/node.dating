...
\textbf{Availability and Implementation:} \code{node.dating} is written in $R$ and requires the $R$ package, \emph{APE}. \code{node.dating} is available in the GitHub repository: https://github.com/brj1/node.dating.git. \\
...
\code{node.dating} is written in \emph{R} and is compatible with the \emph{R} package \emph{APE} \citep{APE}; it is available in the GitHub repository: https://github.com/brj1/node.dating.

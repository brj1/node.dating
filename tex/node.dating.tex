...
\code{node.dating} is available as a part of the $R$ package \emph{ape} (cran.r-project.org).
Supplementary software and tests are available at: https://github.com/brj1/node.dating.  \\
